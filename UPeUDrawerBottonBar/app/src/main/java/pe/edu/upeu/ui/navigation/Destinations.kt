...
sealed class Destinations(
    ...
    object EscuelaUI: Destinations("escuelaUI", "Adm. Escuela", Icons.Filled.Face)

    object EscuelaForm: Destinations("escuelaForm?escuelaId={escuelaId}",
        "Escuela", Icons.Filled.DynamicForm){
        fun passId(escuelaId:String?):String{
            return "escuelaForm?escuelaId=$escuelaId"
        }
    }
}